...
\hline
0:17:39.5 (P1) & And in that process there are activities like create a visual map, create a road& \textbf{[14 task (AS2)]} Student has task ``Create road''\\
\hline
0:24:36.0 (P3)	& And, well interaction. Visualization sorry. Or interaction, I don't know. So create a visual map would have laying out roads and a pattern of their choosing. So this would be first, would be choose a pattern. & \multirow{3}{60mm}{\textbf{[31 critical question CQ?? for 14]} Is Task ``Create road'' clear?\\
\textbf{[32 answer to 31]} no, according to the specification the student should choose a pattern.\\
\textbf{[32a REPLACE]} ``Create road'' becomes ``Choose a pattern''}\\
\cline{1-2}
...
\hline
0:25:07.5 (P1)	& Yeah I'm not sure if they mean that. I don't know what they mean by pattern in this case. I thought you could just pick roads, varying sizes and like, broads of roads. & \textbf{[33 critical question CQ?? for 32a]} Is ``Choose a pattern'' clear?\newline
\textbf{[34 answer to 33]} No, not sure what they mean by a pattern.\\
\hline
0:25:26.0 (P3) & No yeah exactly, but you would have them provide, it's a pattern, it's a different type of road but essentially you would select- how would you call them, selecting a- & \multirow{3}{60mm}{\textbf{[34a REPLACE]} ``Choose a pattern'' becomes ``Choose a pattern preference''}\\
\cline{1-2}
...
\hline
0:25:43.9 (P1) & What kind of patterns though. Would you be able to select & \textbf{[35 critical question CQ?? for 34a]} Is ``Choose a pattern preference'' clear?\newline
\textbf{[36 answer to 35]} no, what kind of pattern?\\
\hline
0:25:47.4 (P3) & Maybe, I don't know it's- & \multirow{2}{60mm}{\textbf{[36a rename]} ``Choose a pattern preference'' becomes ``Choose a road pattern''}\\
\cline{1-2}
