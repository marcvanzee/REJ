...
We start with the definition of various sets of elements that we use in subsequent definitions.

\begin{definition}[Set definitions]
\label{def:set-definitions}
Throughout this section, we adopt the convention that variables start with a lowercase letter, and sets and constants start with an uppercase.
\label{def:ie}
