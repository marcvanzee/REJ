...
\twocolumn[{%
 ...
 \large Marc van Zee\Mark{1},
        Sepideh Ghanavati\Mark{2},
        and Floris Bex\Mark{3}\\[1em]
 \normalsize
 \begin{tabular}{*{3}{>{\centering}p{.33\textwidth}}}
  \Mark{1}Computer Science and Communication (CSC) & \Mark{2}Department of Computer Science  & \Mark{3}Department of Information and Computing Sciences\tabularnewline
  University of Luxembourg & Texas Tech University, USA & Utrecht University\tabularnewline
  \url{marcvanzee@gmail.com} & \url{sepideh.ghanavati@ttu.edu} & \url{f.j.bex@uu.nl}
